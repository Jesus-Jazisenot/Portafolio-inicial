...
const LINKEDIN_URL = "https://www.linkedin.com/in/jes%C3%BAs-antonio-rodr%C3%ADguez-peraza-23743b439";
    ...
    <section id="contacto" className="py-20 px-4 sm:px-6">
      <div className="max-w-3xl mx-auto text-center card-dark p-10 md:p-14 relative overflow-hidden">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center relative">
          ...
          <a href={LINKEDIN_URL} target="_blank" rel="noopener noreferrer" className="btn-primary text-base px-8 py-4 bg-white/10 hover:bg-white/20 shadow-none">
            <IconLinkedIn size={20} />
            LinkedIn
          </a>
        </div>
